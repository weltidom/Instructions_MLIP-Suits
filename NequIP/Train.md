...
dataset_file_name: /home/st/st_us-031400/st_st179390/traj/hea/train/train_2.xyz    # path to data set file
...
#wandb_project: train_0                                                     # project name used in wandb
...
# training
n_train: 4873                                                                       # number of training data
...
batch_size: 10                                                                      # batch size, we found it important to keep this small for most applications including forces (1-5); for energy-only training, higher batch sizes work better
...
mpirun -n 1 nequip-train config_comb.yaml
```